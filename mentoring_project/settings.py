"""
Django settings for mentoring_project project.
...
ALLOWED_HOSTS = ['mentoring.lancegoyke.com', 'lg-mentoring.herokuapp.com', 'localhost', '127.0.0.1',]
...
# Google Analytics
GOOGLE_ANALYTICS = {
    'google_analytics_id': 'UA-6325128-5',
}
